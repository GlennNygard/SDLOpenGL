...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile SDLOpenGL.pro
#############################################################################
...
INCPATH       = -I. -Iinclude -I/home/i7207211/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
DISTDIR = /home/i7207211/SDLOpenGL/obj/SDLOpenGL1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/home/i7207211/NGL/lib -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -L/home/i7207211/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = obj/main.o \
		obj/SDLOpenGL.o
DIST          = SDLOpenGL.pro include/SDLOpenGL.h src/main.cpp \
		src/SDLOpenGL.cpp
...
Makefile: SDLOpenGL.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile SDLOpenGL.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/SDLOpenGL.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/SDLOpenGL.cpp $(DISTDIR)/
...
obj/main.o: src/main.cpp include/SDLOpenGL.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/main.o src/main.cpp

obj/SDLOpenGL.o: src/SDLOpenGL.cpp include/SDLOpenGL.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/SDLOpenGL.o src/SDLOpenGL.cpp
